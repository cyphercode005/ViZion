    ...
    name: "RoadMap",
     data (){
        return {
            dataRoadMap,
            title: 'Roadmap',
            subtitle : 'Our journey continues as we come to the final destination of our launch. View how far we’ve come and how we continue to navigate our success with you, our community.',
        }    
    }
};
</script>
