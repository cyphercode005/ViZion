                ...
                <div class="col-12">
                    <div class="header__body">
                        <div class="header__logo">
                            <a href="/">
                                <img id="site-logo" src="../../assets/images/logo/logo.png" alt="ICOLand" width="165" height="40" data-retina="assets/images/logo/logo-main@x2.png" data-width="165" data-height="40">
                            </a>
                        </div>
                        <div class="header__right">
                            ...
                            <div class="group-button">
                                <router-link class="btn-action" to="/sign-in">
                                    <span>LOGIN</span>
                                </router-link>
                            </div>
