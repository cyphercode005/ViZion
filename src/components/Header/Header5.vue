<template>
        ...
        <header :class="['header style-3', { 'is-fixed': isSticky }]" id="header_main">
                ...
                <div class="col-12">
                    <div class="header__body">
                        <div class="header__logo">
                            <a href="/">
                                <img id="site-logo" src="../../assets/images/logo/logo-04.png" alt="ICOLand" width="165" height="40" data-retina="assets/images/logo/logo-main@x2.png" data-width="165" data-height="40">
                            </a>
                        </div>
                        <div class="header__right">
                            ...
                            <div class="group-button">
                               <a class="btn-action-outline style-1" href="/home-defi-01"><span>EN</span></a>
                               <a class="btn-action style-4" href="/sign-in"><span class="effect">Login</span></a>
                            </div>
