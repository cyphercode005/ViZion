...
<template>
    <div class="banner-top style-1">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-md-12" data-aos="zoom-in" data-aos-duration="800">
                    <div class="banner-top__content">
                        <div class="sale-top">
                            <router-link to="#">MAJOR ANNOUNCEMENT</router-link>
                            <p>Official Utility Coin Offering</p>
                        </div>
                        <h2 class="title">ViZion Protocol. The Future of Blockchain for the Music, Film + Entertainment Industry.</h2>
                        <p class="desc">Our Utility Coin Offering is set to open to the public for a short period. As we prepare for launching our Eco-System of VIZION on the SOLANA blockchain, we are offering Utility Coins to purchase and use within our Revolutionary Blockchain Eco-System. This is NOT AN INVESTMENT OPPORTUNITY. </p>

                        <div class="button">
                            <router-link class="btn-action style-1" to="/sign-up"><span>SECURE YOUR VIZION TOKENS NOW</span><span class="icon-arrow"></span></router-link>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-12" data-aos="fade-up" data-aos-duration="800">
                    <div class="banner-top__sale">
                        <div class="sale-content">
                            <h3>Utility Coin Sale Ends In</h3>
                            <Countdown 
                                starttime="Jul 1, 2022 15:37:25" 
                                endtime="Dec 8, 2023 16:37:25" >
                            </Countdown>
                        
                            <div class="token-bar">
                                <div class="top">
                                    <h6>Raised - <span>555,555 Tokens</span></h6>
                                    <h6>Target - <span>7,000,000 Tokens</span></h6>
                                </div>
                                <div class="main">
                                    <div class="progress-token">
                                        <p class="fs-14">555,555</p>
                                    </div>
                                </div>

                                <div class="bottom">
                                    <p class="fs-14">Hurry!</p>
                                    <p class="fs-14">Crowdsale</p>
                                    <p class="fs-14">Ends Soon!</p>
                                </div>
                            </div>

                            <div class="sale-bottom">
                                <ul class="list-coin">
                                    <li><router-link to="#"><span class="icon-bitcoin"></span></router-link></li>
                                    <li>
                                        <router-link to="#">
                                    ...
                                    <li><router-link to="#"><span class="icon-coinp"></span></router-link></li>
                                    <li><router-link to="#"><span class="icon-kyber-network"></span></router-link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
