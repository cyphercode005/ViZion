...
export const dataFeature = [
    {
        ...
        content: `A Revolutionary New Application that helps Artists book Features from their Idols, Search for Music Labels, Managers, Events, Studios, Music Festival Opportunities and more. 20% of profits go to our liquidity pool every quarter.`,
    },
    {
        id: 2,
        ...
        content: `
        ViZion Protocol includes our revolutionary smart contracts, an iconic NFT + Entertainment Marketplace (iKonX), a
        massive DeFi platform and a first of a kind utility project that can be used for payment for our marketing services, events, hotels, trips, music festivals, and more thru our exclusive partnerships.`,
    },
    {
        id: 3,
    ...
    },
    {
        ...
        content: `With the launch of iKonX, Artists/Musicians will be able to create, sell and distribute their music thru our iKonX platform via NFTS. Since iKonX is built to be the industry standard for trust and security for the music and entertainment industry, this will only build more awareness for more artists to use and launch NFTs on our platform since iKonX is Powered by ViZion Protocol.`,
    },
